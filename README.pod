...
use calibre's ebook-convert 需要安装calibre
...
convert txt to ebook, txt is utf8 encoding，把txt文件转成电子书，txt内容为utf8编码
...
下载小说
    ...
    get_novel.pl -u [url] -t [type] -i [min/max-item-num] -o [dst_file/dst_dir]
