...
local smtp service 本机已安装smtp服务
    ...
    get_ebook.pl "http://www.dddbbb.net/html/18451/index.html" mobi "xxx@kindle.cn" ''  '-f yyy@somesite.cn'

remote smtp service 使用远程smtp服务

    get_ebook.pl "http://www.dddbbb.net/html/18451/index.html" mobi "xxx@kindle.cn" '-i 1-3'  '-f yyy@somesite.cn -s smtp.src.com -xu xxx -xp somepwd'
