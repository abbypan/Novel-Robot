...
下载小说
    ...
    get_novel.pl -u [url] -t [type] -i [min_item_num-max_item_num] -c [cookie] -o [dst_file/dst_dir]
    get_novel.pl -u [小说目录页url] -t [目标文件类型] -i [起止章节号] -c [cookie登录信息] -o [目标文件名/目标文件夹]
    ...
    get_novel.pl -u "http://www.jjwxc.net/onebook.php?novelid=217747" -i 33-34 -c cookies.txt
    get_novel.pl -u "http://www.jjwxc.net/onebook.php?novelid=217747" -i 33-34 -c ~/.mozilla/firefox/*/cookies.sqlite
    get_novel.pl -u "http://www.jjwxc.net/onebook.php?novelid=217747" -i 33-34 -c "name1=value1; name2=value2"
