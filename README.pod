...
=head2 download and convert novel

    just download and convert ebook, 简单下载或处理电子书

only download novel and convert to ebook 只下载小说并转换为电子书

    run_novel.pl -u "http://www.dddbbb.net/html/18451/index.html" -T mobi
    run_novel.pl -u "http://www.dddbbb.net/html/18451/index.html" -o mytest.epub

only download 1-3 chapter 只下载小说的1-3章，最终输出文件名为abc.mobi

    run_novel.pl -u "http://www.dddbbb.net/html/18451/index.html" -o abc.mobi -G "-i 1-3"
...
download novel, and send mobi to email address : xxx@kindle.cn， 下载小说并推送到指定邮箱

local smtp service 本机已安装smtp服务

    run_novel.pl -u "http://www.dddbbb.net/html/18451/index.html" -T mobi -t "xxx@kindle.cn" -S "-f yyy@somesite.cn"

remote smtp service 使用远程smtp服务

    run_novel.pl -u "http://www.dddbbb.net/html/18451/index.html" -T mobi -t "xxx@kindle.cn" -G "-i 1-3"  -S "-f yyy@somesite.cn -s smtp.src.com -xu xxx -xp somepwd"

use ansible，push ebook to remote host, and then sendEmail

    run_novel.pl -h remote.vps.com -u "http://www.dddbbb.net/html/18451/index.html" -T mobi -t "xxx@kindle.cn" -S "-f yyy@somesite.cn"

=head2 ARG

    -u : book url，小说url
    -t : send to email address，推送的邮箱地址
